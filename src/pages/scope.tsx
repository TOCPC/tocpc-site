            ...
            <div className="prose prose-md">
              <ol>
                <li>
                  ...
                  (โดยการันตีได้แค่ภาษา C, C++ และ Rust เท่านั้นที่จะ Compile
                  ผ่านทุกข้อ) ไม่อนุญาตให้เขียนโปรแกรมที่ทำงานใน Graphic Mode
                </li>
                <li>
                ...
                <li>
                  ...
                  ให้ใช้นามสกุล .cpp ภาษา Java ให้ใช้ .java ภาษา Python ให้ใช้
                  .py ภาษา Rust ให้ใช้ .rs และต้องอยู่ในรูปแบบที่สามารถแปล
                  (compile)
                  ให้เป็นโปรแกรมที่สามารถทำงานได้โดยสมบูรณ์จากบรรทัดคำสั่ง
                  (command line)
                </li>
                <li>
                  โปรแกรมจะถูกสั่งให้ทำงานบนระบบปฏิบัติการ Linux Compiler
                  สำหรับภาษาต่างๆ มีรายละเอียดดังนี้
                  <ul>
                    <li>สำหรับภาษา C และ C++ ใช้ gcc 9.3.0</li>
                    <li>สำหรับภาษา Java ใช้ openjdk 17 2021-09-14</li>
                    <li>สำหรับภาษา Python ใช้ Python 3.8.10</li>
                    <li>สำหรับภาษา Rust ใช้ rustc 1.51.0</li>
                  </ul>
                </li>
                <li>
                  สำหรับภาษา C และ C++ คอมไพเลอร์ออปชัน (compiler option)
                  ที่ใช้ในการแข่งขันจะทำการออปทิไมซ์ (optimize)
                  โปรแกรมโดยใช้ออปชัน -O2 สำหรับภาษา Rust คอมไพเลอร์ออปชัน
                  (compiler option) ที่ใช้ในการแข่งขันจะทำการออปทิไมซ์
                  (optimize) โปรแกรมโดยใช้ออปชัน -O (นั่นคือ -C opt-level=2)
                  โดยคำสั่งที่ใช้ในการแปลโปรแกรมแต่ละภาษา
                  จะปรากฎให้ผู้เข้าแข่งขันเห็นบนระบบ CMS
                </li>
                <li>
                  สำหรับโปรแกรมภาษา C อนุญาตให้เขียนโปรแกรมภาษา C ตามมาตรฐาน C11
                  โดยคอมไพเลอร์ออปชันที่กำหนดเพิ่มใช้ออปชัน -std=gnu11
                  สำหรับโปรแกรมภาษา C++ อนุญาตให้เขียนโปรแกรมภาษา C++ ตามมาตรฐาน
                  C++11 โดยคอมไพเลอร์ออปชันที่กำหนดเพิ่มใช้ออปชัน -std=gnu++11
                </li>
              </ol>
            </div>
          </div>
