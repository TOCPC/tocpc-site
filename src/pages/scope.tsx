          ...
          <p>
            ...
            <ol className="list-decimal">
                ...
                <ul className="list-circle">
                  <li className="ml-6">
                    ...
                    <ul className="list-square">
                      ...
                      <li className="ml-6">1.1.2 เลขเศษส่วน และร้อยละ</li>
                      <li className="ml-6">
                  ...
                  <li className="ml-6">
                    ...
                    <ul className="list-square">
                      ...
                      <li className="ml-6">1.2.2 ตรรกศาสตร์พื้นฐาน</li>
                      <li className="ml-6">1.2.3 วิธีการพิสูจน์</li>
                      <li className="ml-6">
                  ...
                  <li className="ml-6">
                    ...
                    <ul className="list-square">
                      <li className="ml-6">1.3.1 แคลคูลัส</li>
                      <li className="ml-6">1.3.2 ความน่าจะเป็น</li>
                      <li className="ml-6">1.3.3 สถิติ</li>
                      <li className="ml-6">1.3.4 จำนวนจริงและจำนวนเชิงซ้อน</li>
                      <li className="ml-6">
              ...
              <li className="ml-6 py-2">
                ...
                <ul className="list-circle">
                  <li className="ml-6">2.1 พื้นฐานด้านการเขียนโปรแกรม</li>
                  <li className="ml-6">
                  ...
                  <li className="ml-6">
                    ...
                    <ul className="list-square">
                      ...
                      <li className="ml-6">2.3.3 Record/Struct</li>
                      <li className="ml-6">
                  ...
                  <li className="ml-6">
                    ...
                    <ul className="list-square">
                      <li className="ml-6">2.4.1 แนวคิด</li>
                      <li className="ml-6">
              ...
              <li className="ml-6 py-2">
                ...
                <ul className="list-circle">
                  ...
                  <li className="ml-6">
                    ...
                    <ul className="list-square">
                      <li className="ml-6">3.2.1 Brute-Force algorithm</li>
                      <li className="ml-6">3.2.2 Greedy algorithm</li>
                      <li className="ml-6">3.2.3 การแบ่งแยกและเอาชนะ</li>
                      <li className="ml-6">
                        3.2.4 Backtracking (ทั้งที่เป็นแบบเรียกตัวเองซ้ำ
                        และไม่เรียกตัวเองซ้ำ)
                      </li>
                      <li className="ml-6">3.2.5 Branch-and-Bound algorithm</li>
                      <li className="ml-6">
                        3.2.6 Pattern matching and string/text algorithm
                      </li>
                      <li className="ml-6">3.2.7 Dynamic programming</li>
                    </ul>
                  </li>
                  <li className="ml-6">
                    ...
                    <ul className="list-square">
                      ...
                      <li className="ml-6">3.3.4 Search by elimination</li>
                      <li className="ml-6">
                      ...
                      <li className="ml-6">3.3.12 Minimum spanning tree</li>
                      <li className="ml-6">3.3.13 Topological sort</li>
                    </ul>
                  </li>
                </ul>
              </li>
            ...
            <ol className="list-decimal">
              ...
              <li className="ml-6 py-2">
                ...
                <ul className="list-disc list-circle">
                  <li className="ml-6 py-2">
